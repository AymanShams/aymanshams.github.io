...
| DEC-009 | Contact | Which contact methods are in v1? | Include GitHub and LinkedIn when URLs are verified. Omit email until the user supplies a public address. | User delegated judgment | Approved | PRD, frontend |
